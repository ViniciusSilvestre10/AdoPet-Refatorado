...
public class AdocaoService {
    ...
    @Autowired
    private List<ValidacaoSolicitacaoAdocao> validacaoSolicitacaoAdocao;
    ...
    public  void solicitar(SolicitacaoAdocaoDto dto){
        ...
        validacaoSolicitacaoAdocao.forEach(v->v.validar(dto));
    ...
    public void reprovar(ReprovacaoAdocaoDto dto){
        Adocao adocao = repository.getReferenceById(dto.idAdocao());
        adocao.marcaComoReprovada(adocao.getJustificativaStatus());
